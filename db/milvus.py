import sys
from config.config import MILVUS_HOST, MILVUS_PORT, VECTOR_DIMENSION, METRIC_TYPE, DEFAULT_TABLE
...
def load_vecs(table_name: str, feat: List[T], milvus_client: MilvusHelper):
    try:
        if not table_name:
